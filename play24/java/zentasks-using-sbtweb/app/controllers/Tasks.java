...
public class Tasks extends Controller {
     ...
     */
    public Result index(Long project) {
     ...
     */ 
    public Result add(Long project, String folder) {
        if(Secured.isMemberOf(project)) {
     ...
     * Update a task
     */  
    public Result update(Long task) {
     ...
     * Delete a task
     */
    public Result delete(Long task) {
        if(Secured.isOwnerOf(task)) {
     ...
     */
    public Result deleteFolder(Long project, String folder) {
        if(Secured.isMemberOf(project)) {
     ...
     */
    public Result renameFolder(Long project, String folder) {
        if(Secured.isMemberOf(project)) {
            return ok(
