...
public class Wizard extends Controller {
	 ...
	 */
	private User toUser(Map<String, String> session) {
	 ...
	 * Serialize our form data to a Map
 	 */
	private Map<String, String> toMap(Form<?> user) {
		 // Fill the form with data session
    ...
    private Result handleStep1Submission() {
	...
	private Result handleStep2Submission() {
